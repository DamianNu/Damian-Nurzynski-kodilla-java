...
public class Game {
    ...
    public static void panel() {
        ...
        String stats = ("\n \u001B[34m" + "Current game statistics: " + "Player > " + "\u001B[33m");
        ...
        while (!end) {
            if (scoring.getPointsComputer() == starterGames.getRound() ||
                ...
                if (scoring.getPointsPlayer() > scoring.getPointsComputer()) {
                    System.out.println(stats + scoring.getPointsPlayer() + ":" +
                            scoring.getPointsComputer() + stats2
                            + "\nPlayer wins \u001B[35mCong" +
                            "\u001B[34mratu\u001B[33mlati\u001B[31mons!!\u001B[0m\n");
                } else {
                    System.out.println(stats + scoring.getPointsPlayer() + ":"
                            + scoring.getPointsComputer() + stats2 + "\n  > You lose <\n");
                }
